...
export default function FlyerGenerator() {
  ...
  const [layout, setLayout] = useState({
    ...
    category: { top: 22.5, fontSize: 24, color: '#ffffff' },
          ...
          {bgImage && selectedNominee && (
            <div className="glass-card p-6 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-dark-200 border-b border-dark-800 pb-2">Category Text</h3>
                ...
                >
                  ...
                  >
                    {selectedNominee.photo_url ? (
                      <img src={selectedNominee.photo_url} alt="Nominee" className="w-full h-full object-cover" crossOrigin="anonymous" />
                    ) : (
